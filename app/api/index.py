...
# ──── Datos de ejemplo ────
RAW_EVENTS = [
    ("ProveedorNuevo", "DIOR",           "CHILE LUX",  "05-sep-25"),
    ...
    ("ProveedorNuevo", "COTY MASSTIGE",  "PANAMÁ",     "08-sep-25"),  # corregido
    ("ProveedorNuevo", "CHANEL",         "PANAMÁ",     "05-sep-25"),
    ("ProveedorNuevo", "CHANEL",         "COLOMBIA",   "05-sep-25"),
    ("ProveedorNuevo", "CHANEL",         "COSTA RICA", "05-sep-25"),
    ("ProveedorNuevo", "DIOR",           "COLOMBIA",   "05-sep-25"),
    ("ProveedorNuevo", "SWAROVSKI",      "COLOMBIA",   "29-sep-25"),
    ("ProveedorNuevo", "PUPA MILANO",    "COSTA RICA", "15-sep-25"),
    ("ProveedorNuevo", "PUPA MILANO",    "PANAMÁ",     "15-sep-25"),
    ("ProveedorNuevo", "Fenty",          "CHILE LUX",  "05-sep-25"),
    ("ProveedorNuevo", "LOREAL",         "COLOMBIA",   "08-sep-25"),
    ("ProveedorNuevo", "FENTY",          "PANAMÁ",     "05-sep-25"),
    ("ProveedorNuevo", "FENTY",          "COSTA RICA", "05-sep-25"),
    ("ProveedorNuevo", "FENTY",          "PERU",       "05-sep-25"),
    ("ProveedorNuevo", "VICTORIA SECRET",             "PANAMÁ",   "29-sep-25"),
    ("ProveedorNuevo", "Bath & Body Works",           "PANAMÁ",   "29-sep-25"),
    ("ProveedorNuevo", "VICTORIA SECRET",             "COLOMBIA", "29-sep-25"),
    ("ProveedorNuevo", "VS FLOORSET",    "COLOMBIA", "02-sep-25"),
    ("ProveedorNuevo", "VS FLOORSET",    "PANAMÁ",   "02-sep-25"),
    ("ProveedorNuevo", "DIOR FEDURO",                 "PANAMÁ",   "03-sep-25"),
    ("ProveedorNuevo", "ESTEE LAUDER",                "PANAMÁ",   "05-sep-25"),
    ("ProveedorNuevo", "ACTIUM",                      "PANAMÁ",   "05-sep-25"),
    ("ProveedorNuevo", "BELUXE",                      "PANAMÁ",   "12-sep-25"),
]
